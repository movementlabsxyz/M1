...
# movement 1.0.5
# Movement Labs <tony@movementlabs.xyz>
...
The current test generates a new key via the Movement CLI and ensures the shell output matches the filename(s) for that key.
